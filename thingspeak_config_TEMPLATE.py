# 1. Enter the server, channel and api keys for your Thingspeak account
# 2. Change the file name to thingspeak_config.py
# 3. Save the file in the same directory as the main.py file
